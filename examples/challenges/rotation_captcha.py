"""3D rotation CAPTCHA challenge. Requires: pip install tollbooth[image]"""

from collections.abc import Iterable
from typing import Any
from wsgiref.simple_server import make_server

from tollbooth import RotationCaptcha, Rule, TollboothWSGI
...
if __name__ == "__main__":
    handler = RotationCaptcha(
        secret=SECRET.encode(),
    )
    wrapped = TollboothWSGI(app, SECRET, rules=RULES, challenge_handler=handler)
    print("RotationCaptcha challenge on http://localhost:8000")
