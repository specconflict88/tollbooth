"""Circle CAPTCHA — click the incomplete circle. Requires: pip install tollbooth[image]"""

from collections.abc import Iterable
from typing import Any
from wsgiref.simple_server import make_server

from tollbooth import CircleCaptcha, Rule, TollboothWSGI
...
if __name__ == "__main__":
    handler = CircleCaptcha(secret=SECRET.encode())
    wrapped = TollboothWSGI(app, SECRET, rules=RULES, challenge_handler=handler)
    print("CircleCaptcha challenge on http://localhost:8000")
