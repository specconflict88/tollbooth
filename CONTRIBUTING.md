...
- **Report bugs** — [open an issue](https://github.com/libcaptcha/tollbooth/issues/new) with steps to reproduce
- **Suggest features** — [start a discussion](https://github.com/libcaptcha/tollbooth/issues/new) describing the use case
- **Fix bugs** — browse [open issues](https://github.com/libcaptcha/tollbooth/issues) and submit a PR
...
Look for issues labeled [`good first issue`](https://github.com/libcaptcha/tollbooth/labels/good%20first%20issue) — these are scoped, well-defined tasks ideal for getting familiar with the codebase.
